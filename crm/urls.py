...
urlpatterns = [
    ...
    path(
        "view_edit_customer/p=<int:id>",
        views.view_edit_customer,
        name="view_edit_customer",
    ),
    path("veiw_client/p=<int:id>", views.veiw_client, name="veiw_client"),
    path("add_customer/", views.add_customer, name="add_customer"),
    path(
        "view_add_contact/p=<int:id>", views.view_add_contact, name="view_add_contact"
    ),
    ...
    path(
        "send_show_temp_whatsapp",
        views.send_show_temp_whatsapp,
        name="send_show_temp_whatsapp",
    ),
